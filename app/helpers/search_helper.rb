module SearchHelper
  ...
  def help_autocomplete
    [
      { category: "Help", label: "API 帮助",           url: help_page_path("api/README") },
      { category: "Help", label: "Markdown 帮助",      url: help_page_path("markdown/markdown") },
      { category: "Help", label: "权限帮助",   url: help_page_path("user/permissions") },
      { category: "Help", label: "公开访问帮助", url: help_page_path("public_access/public_access") },
      { category: "Help", label: "Rake 任务帮助",    url: help_page_path("raketasks/README") },
      { category: "Help", label: "SSH 密钥帮助",      url: help_page_path("ssh/README") },
      { category: "Help", label: "系统钩子帮助",  url: help_page_path("system_hooks/system_hooks") },
      { category: "Help", label: "Web 钩子帮助",      url: help_page_path("web_hooks/web_hooks") },
      { category: "Help", label: "工作流帮助",      url: help_page_path("workflow/README") },
    ]
  end
