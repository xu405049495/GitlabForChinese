  ...
  describe '#host_without_www' do
    context 'URL with protocol' do
      it 'returns the host' do
        ...
        expect(Settings.host_without_www('http://cn.gravatar.com/avatar/%{hash}?s=%{size}&d=identicon')).to eq 'gravatar.com'
    ...
    context 'URL without protocol' do
      it 'returns the host' do
        ...
        expect(Settings.host_without_www('cn.gravatar.com/avatar/%{hash}?s=%{size}&d=identicon')).to eq 'gravatar.com'
      end
      ...
      context 'URL with user/port' do
        it 'returns the host' do
          ...
          expect(Settings.host_without_www('bob:pass@cn.gravatar.com:8080/avatar/%{hash}?s=%{size}&d=identicon')).to eq 'gravatar.com'
          ...
          expect(Settings.host_without_www('http://bob:pass@cn.gravatar.com:8080/avatar/%{hash}?s=%{size}&d=identicon')).to eq 'gravatar.com'
        end
      end
    end
  end
